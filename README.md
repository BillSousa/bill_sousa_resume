...
| **Proficient / Expert**                                                           |                                                                        |       |
|-----------------------------------------------------------------------------------|------------------------------------------------------------------------|-------|
| Windows and Linux Operating systems                                               | Excel (VBA, Solver, PowerPivot)                                        | MySQL, SQL Server  |
...
| Power BI Desktop / Service | Base SAS | Supervised Neural Networks (scikit, tensorflow, pytorch) |
...
gas chromatography (GC), digital microscopy, wet analysis\
**Lean / Six Sigma Tools:**\
Lean / six sigma green belt, Pareto / histogram analysis, statistical process control (SPC), 
multiple linear & logistic regression, normality testing, 5S, FMEA, kaizen, kanban, C&E matrix, 
mistake proofing, RPN, root cause analysis
